    ...
    <body>
        <%
                  ...
                  //  out.print("<iframe src='"+data+"'>");
                    ...
                    PreparedStatement ps = c.prepareStatement("insert into notice(date,notice,data)values(?,?,?)");
                   // ps.setString(1,"");
                    ...
                    out.println("<script>alert('notice added'); window.location.href='admin_notice.jsp'</script>");
                     ...
                     out.println(e);
                   //  out.println("<script>alert('notice not added try try with different file attachment'); window.location.href='admin_notice.jsp'</script>");
                 }
