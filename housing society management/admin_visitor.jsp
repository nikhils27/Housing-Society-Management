    ...
    <jsp:include page="admin_header.html"/>
        <div class="contain">
            <div class="btn-group">
                ...
                <a href="visitor_add.jsp"><button class="b3">add visitors</button></a>
            </div>    
            <div class="all">
                <center><h2 style="background-color:rgba(0,0,0,0.5);color:white;width:50%;">All Visitors</h2></center>
                <center>
                    <table id="123">
            ...
            <div class="today">
                <center><h2 style="background-color:rgba(0,0,0,0.5);color:white;width:50%;">Todays Visitors</h2></center>
                <center>
                    <table>
